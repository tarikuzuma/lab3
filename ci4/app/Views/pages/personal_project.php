      ...
      <section class="hidden project_section">
        <div class="project_content">
            ...
            <div class="container">
                ...
                <div class="about">
                    A compilation of ready to use calculators caterd to fit the needs of an architecture student.
                </div>
      ...
      <section class = "hidden">
        <div class = "cards_projects_main">
          <div class = "row">
            <a href="academic_projects" class="card hidden2" style="transition: 2s;">
